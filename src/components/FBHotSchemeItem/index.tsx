      ...
      <div className={styles.header}>
        <div className={styles.expert_box} onClick={() => toExpert(scheme.expert_id)}>
          ...
          <div className={styles.nickname_box}>
            ...
            <Space>
              {scheme.hit_tag ? (
                <FBExpertTag color={color} type={FBTagType.HitRate} tag={scheme.hit_tag} />
              ) : null}
              {scheme.continuous_tag ? (
                <FBExpertTag color={color} type={FBTagType.Continue} tag={scheme.continuous_tag} />
              ) : null}
            </Space>
          </div>
        </div>
