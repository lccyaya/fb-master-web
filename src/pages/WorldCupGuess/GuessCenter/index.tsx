    ...
    const content = (
        <div>
            ...
            <div style={{ borderTop: "1px solid #EEEEEE" }}>
                ...
                <div className="guess_play">竞猜选项
                    <div className="guess_playbg" >让球胜平负</div>
                </div>
                <div className="guess_play">过关方式   <div className="guess_playbg"  >让球胜平负</div></div>
                <div className="guess_play">能量消耗   <div className="guess_playbg" >让球胜平负</div></div>
                <div className="guess_play">最高奖励   <div className="guess_playbg" >让球胜平负</div></div>
            </div>
        </div>
    )
    ...
    return (
        <div className={styles.guesscenter_info}>
            ...
            <div className={styles.guesscenter_bottom_box}>
                ...
                {!user ? <div className={styles.select_login_box}>沉浸式免费体验世界杯
                    <div className={styles.login} onClick={() => {
                        history.push("/zh/mine")
                    }}>立即登录</div>
                </div> : selectvalue.length ? <FBGuessEnergy onOk={onSrue}></FBGuessEnergy>
